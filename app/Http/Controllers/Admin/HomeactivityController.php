...
class HomeactivityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.modules.home-activity.index',compact('activity'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.modules.home-activity.create',compact('categories', 'subCategories'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $categories=Category::all();
        $subCategories=SubCategory::all();
        return view('admin.modules.home-activity.edit',compact('activity', 'categories', 'subCategories'));
    }
