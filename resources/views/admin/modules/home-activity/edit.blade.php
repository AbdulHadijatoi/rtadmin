...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{route('homeactivities.update',$activity->id)}}"  method="post" id="activity-form">
            @csrf
            @method('put')
          ...
          <div class="form-group" style="display: none;">
            <label for="exampleInputName1">Home Activity</label>
            <input type="hidden" class="form-control @error('home_activity') is-invalid @enderror"
                id="exampleInputName1" placeholder="" name="home_activity" value="1">
            @error('home_activity')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
