...
class OtherExperianceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.modules.other-experiance.index',compact('activity'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.modules.other-experiance.create',compact('categories', 'subCategories'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $categories=Category::all();
        $subCategories=SubCategory::all();
        return view('admin.modules.other-experiance.edit',compact('activity', 'categories', 'subCategories'));
    }
