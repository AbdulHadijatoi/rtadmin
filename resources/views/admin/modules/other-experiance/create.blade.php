        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('otherexperiances.store') }}" method="post" id="activity-form" id="my-form">
                        @csrf
                        ...
                        <div class="form-group" style="display: none;">
                            <label for="exampleInputName1">Experiences</label>
                            <input type="hidden" class="form-control @error('otherexpereience_activity') is-invalid @enderror"
                                id="exampleInputName1" placeholder="" name="otherexpereience_activity" value="1">
