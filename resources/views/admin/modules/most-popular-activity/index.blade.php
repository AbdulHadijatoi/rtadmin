            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{route('mostpopularactivities.create')}}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="actionDropdown">
                                                    <a class="dropdown-item"
                                                        href="{{ route('mostpopularactivities.edit', $value->id) }}">Edit</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('mostpopularactivities.destroy', $value->id) }}"
                                                    ...
                                                    <form id="delete-form-{{ $value->id }}"
                                                        action="{{ route('mostpopularactivities.destroy', $value->id) }}"
